Public Class TaskBox
    ...
    Public Sub createThumbnail(ByVal height_, titleParams, projectParams, durationParams, remainingParams, member)

        Dim title, project, projectVal, duration, durationVal, remaining, remainingVal, assigned, assignedVal As New Label
